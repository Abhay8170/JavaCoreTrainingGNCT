...
Step 1: Creating an interface using interface keyword
...
Step 4: Create an object of the class and call the methods to demonstrate abstraction.
Step 5: Run the program to see how abstraction works in Java.
...
We can create an interface called "vehicle" that defines common behaviors of all vehicles, such as start(), stop(), and accelerate(). 
Then, we can create specific classes like "Car", "Bike", and "Bus" that implement the Vehicle interface and provide their own implementations of the methods. 
This way, we can manage different types of vehicles in the transportation system while keeping the common functionalities
*/